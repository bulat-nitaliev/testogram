...
class UserTestCase(APITestCase):
    ...
    def test_retrieve_user(self):
        ...
        target_user.save()
        # posts
        post_1 = PostFactory(author=target_user, title="Post_1")
        post_2 = PostFactory(author=target_user, title="Post_2")
        # other posts
            ...
            "posts": [
                {
                    ...
                    "title": post_1.title,
                    "body": post_1.body,
                    "created_at": make_naive(post_1.created_at).strftime("%Y-%m-%dT%H:%M:%S"),
                },
                {
                    "id": post_2.id,
                    "title": post_2.title,
                    "body": post_2.body,
                    "created_at": make_naive(post_2.created_at).strftime("%Y-%m-%dT%H:%M:%S"),
                },
            ],
        }
